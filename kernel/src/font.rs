...
// Copied verbatim from desktop/src/font.rs — pure static data, no OS calls.
// Each entry is [u8; 8], one byte per row, MSB = leftmost pixel.
...
pub const FONT: [[u8; 8]; 95] = [
    ...
    // 0x26 &
    [0x38, 0x6C, 0x68, 0x76, 0x6E, 0x66, 0x3B, 0x00],
    // 0x27 '
    ...
    // 0x33 3
    [0x7E, 0x06, 0x0C, 0x1E, 0x06, 0x66, 0x3C, 0x00],
    // 0x34 4
